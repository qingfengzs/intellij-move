...
class UnusedTestSignerInspectionTest : InspectionTestBase(UnusedTestSignerInspection::class) {
    ...
    fun `test unused signer remove by quickfix at the end`() = checkFixByText(
        "Remove 'acc_2'", """
    module 0x1::M {
    ...
    fun `test unused signer remove by quickfix in the middle`() = checkFixByText(
        "Remove 'acc_2'", """
    module 0x1::M {
    ...
    fun `test unused signer remove by quickfix at the beginning`() = checkFixByText(
        "Remove 'acc_2'", """
    module 0x1::M {
    ...
    fun `test unused signer remove by quickfix multiline`() = checkFixByText(
        "Remove 'acc2'", """
    module 0x1::M {
        #[test(
            acc1 = @0x1,
