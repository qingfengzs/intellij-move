...
import org.sui.lang.core.psi.SuiMvPsiManager.Companion.isIgnorePsiEvents
import org.sui.lang.core.psi.MvPsiTreeChangeEvent.*

/** Don't subscribe directly or via plugin.xml lazy listeners. Use [SuiMvPsiManager.subscribeMoveStructureChange] */
...
/** Don't subscribe directly or via plugin.xml lazy listeners. Use [SuiMvPsiManager.subscribeRustPsiChange] */
...
interface SuiMvPsiManager {
    ...
    /** This is an instance method because [SuiMvPsiManager] should be created prior to event subscription */
...
class SuiMvPsiManagerImpl(val project: Project) : SuiMvPsiManager, Disposable {
    ...
    init {
        ...
        project.messageBus.connect()
            .subscribe(SuiMoveProjectsService.SUI_MOVE_PROJECTS_TOPIC, MoveProjectsListener { _, _ ->
                incStructureModificationCount()
            })
    }
...
//        }
        ...
        project.messageBus.syncPublisher(SUI_MOVE_PSI_CHANGE_TOPIC).movePsiChanged(file, psi, isStructureModification)
    }
...
val Project.movePsiManager: SuiMvPsiManager get() = service()
...
/**
 * Returns [SuiMvPsiManager.moveStructureModificationTracker] or [PsiModificationTracker.MODIFICATION_COUNT]
