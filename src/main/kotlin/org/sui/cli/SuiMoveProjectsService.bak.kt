...
//
////val Project.moveProjectsService get() = service<SuiMoveProjectsService>()
////
////val Project.hasMoveProject get() = this.moveProjectsService.allProjects.isNotEmpty()
//
//class `SuiMoveProjectsService.bak`(val project: Project) : Disposable {
//
...
//        MoveProjectsService.LOG.logProjectsRefresh("scheduled", reason)
//        val moveProjectsFut =
//            modifyProjectModel {
...
//        //readaccessrequiredforthepsiElement.containingFile
...
//                        project.messageBus
//                            .syncPublisher(SUI_MOVE_PROJECTS_TOPIC).moveProjectsUpdated(this, projects)
//                        initialized = true
//                    }
//                }
//                projects
...
//
//    companion object {
////        private val LOG = logger<SuiMoveProjectsService>()
//
//        val SUI_MOVE_PROJECTS_TOPIC: Topic<MoveProjectsListener> = Topic.create(
...
//        fun moveProjectsUpdated(service: `SuiMoveProjectsService.bak`, projects: Collection<MoveProject>)
//    }
//}
//
