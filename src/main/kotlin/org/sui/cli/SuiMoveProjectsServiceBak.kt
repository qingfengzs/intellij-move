...
class SuiMoveProjectsServiceBak(val project: Project) : Disposable {
...
//        private val LOG = logger<SuiMoveProjectsService>()
    ...
    fun interface MoveProjectsListener {
        fun moveProjectsUpdated(service: SuiMoveProjectsServiceBak, projects: Collection<MoveProject>)
    }
}
