...
import org.sui.stdext.IndexEntry
import org.sui.stdext.MoveProjectsIndex
...
val Project.moveProjects get() = service<SuiMoveProjectsService>()

val Project.hasMoveProject get() = this.moveProjects.allProjects.isNotEmpty()

class SuiMoveProjectsService(val project: Project) : Disposable {
    ...
    fun interface MoveProjectsListener {
        fun moveProjectsUpdated(service: SuiMoveProjectsService, projects: Collection<MoveProject>)
    }
