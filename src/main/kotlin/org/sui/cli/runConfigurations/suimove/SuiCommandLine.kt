...
import org.sui.cli.runConfigurations.suimove.any.AnyCommandConfigurationFactory
...
data class SuiCommandLine(
    ...
    fun toGeneralCommandLine(suiExecutor: SuiCliExecutor): GeneralCommandLine {
        val generalCommandLine = GeneralCommandLine()
            .withExePath(suiExecutor.location.toString())
