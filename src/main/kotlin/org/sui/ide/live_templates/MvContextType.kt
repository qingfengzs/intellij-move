package org.sui.ide.live_templates
...
import org.sui.ide.MvHighlighter
...
sealed class MvContextType(
    ...
    class Generic : MvContextType("SUI_MOVE_FILE", "Move", EverywhereContextType::class) {
        override fun isInContext(element: PsiElement) = true
    }

    class Module : MvContextType("SUI_MOVE_MODULE", "Module", Generic::class) {
        override fun isInContext(element: PsiElement): Boolean
        // inside MvModuleDef
                = owner(element) is MvModule
    }

    class Block : MvContextType("SUI_MOVE_BLOCK", "Block", Generic::class) {
        override fun isInContext(element: PsiElement): Boolean
        // inside MvCodeBlock
